...
//Captcha background red, green, blue
$bgRed = 255;
$bgGreen = 255;
$bgBlue = 255;

//Captcha String Formatting
$red = 155;
$green = 155;
$blue = 155;
$randomize_color = 0;	//0:false;1:true
$rotate_angle = 0;
$rotate_string = 0;	//0:false;1:true

// Various obfuscation techniques.
$num_polygons = 0;//3; // Number of triangles to draw.  0 = none
$num_ellipses = 0;//6;  // Number of ellipses to draw.  0 = none
