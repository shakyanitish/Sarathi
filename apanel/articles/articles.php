...
$article_type = array('1' => 'Home Page', '2' => 'Inner Page');
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                foreach ($records as $key => $record): ?>
                    <tr id="<?php echo $record->id; ?>">
                        ...
                        <td><?php echo $article_type[$record->type]; ?></td>
            ...
            <form action="" class="col-md-12 center-margin" id="articles_frm">
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <select name="type" class="col-md-2 validate[required]">
                            <option value="">Choose Type</option>
                            <?php foreach ($article_type as $atid => $atname) {
                                $seltype = (!empty($articlesInfo->type) and $articlesInfo->type == $atid) ? ' selected' : '';
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <input placeholder="Article Title" class="col-md-6 validate[required,length[0,200]]" type="text" name="title" id="title"
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10 uploader3 <?php echo !empty($articlesInfo->fb_upload) ? "hide" : ""; ?>">
                    ...
                    <?php if (!empty($articlesInfo->fb_upload)): ?>
                        <div class="col-md-2" id="removeSavedimg3">
                            <div class="infobox info-bg">
                                <div class="button-group" data-toggle="buttons">
                                    <span class="float-left">
                                        <?php
                                        if (file_exists(SITE_ROOT . "images/articles/social/" . $articlesInfo->fb_upload)):
                                            $filesize = filesize(SITE_ROOT . "images/articles/social/" . $articlesInfo->fb_upload);
                                            echo 'Size : ' . getFileFormattedSize($filesize);
                                        endif;
                                        ?>
                                    </span>
                                    <a class="btn small float-right" href="javascript:void(0);"
                                       onclick="deleteSavedArticlesimage(3);">
                                        <i class="glyph-icon icon-trash-o"></i>
                                    </a>
                                </div>
                                <img src="<?php echo IMAGE_PATH . 'articles/social/thumbnails/' . $articlesInfo->fb_upload; ?>"
                                     style="width:100%"/>
                                <input type="hidden" name="imageArrayname3" value="<?php echo $articlesInfo->fb_upload; ?>"/>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="form-row">
                    <div class="form-label col-md-12">
                        ...
                        <textarea name="brief" id="brief"
                                  class="large-textarea validate[required]"><?php echo !empty($articlesInfo->brief) ? $articlesInfo->brief : ""; ?></textarea>
                    </div>
                </div>
        ...
        $(document).ready(function () {
            ...
            $('#fb_upload').uploadify({
                ...
                'formData': {
                    ...
                    targetFolder: 'images/articles/social/',
                    thumb_width: 200,
                    thumb_height: 200
                },
                'method': 'post',
                ...
                'onUploadSuccess': function (file, data, response) {
                    $('#uploadedImageName').val('1');
                    var filename = data;
                    $.post('<?php echo BASE_URL;?>apanel/articles/uploaded_fb_image.php', {imagefile: filename}, function (msg) {
