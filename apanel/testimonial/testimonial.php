            ...
            <form action="" class="col-md-12 center-margin" id="testimonial_frm">
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input placeholder="Name" class="col-md-6 validate[required,length[0,200]]" type="text" name="name"
                            id="name" value="<?php echo !empty($testimonialInfo->name) ? $testimonialInfo->name : ""; ?>">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-label col-md-2">
                ...
                <div class="form-row">
                    ...
                    <div id="preview_Image"><input type="hidden" name="imageArrayname"
                            value="<?php echo !empty($testimonialInfo->image) ? $testimonialInfo->image : ""; ?>" class="" />
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <select class="col-md-6" name="rating" id="rating">
                            ...
                            <?php for ($i = 1; $i <= 5; $i++) {
                                $sel = (!empty($testimonialInfo->rating) && $testimonialInfo->rating == $i) ? 'selected' : '';
