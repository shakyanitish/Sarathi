    ...
    <div class="row">
        <div class="form-row col-md-12">
            <div class="form-input col-md-10">
               ...
               <label><small>Image Dimensions (1500 px X 800 px)</small></label>
            </div>
...
//$newrecRow = ($ic++%4==0)?'</div><div class="row">':'';?>      
     <div class="col-md-3 removeSavedimg<?php echo $galleryRow->id;?> oldsort" id="<?php echo $galleryRow->id;?>" csort="<?php echo $galleryRow->id;?>">
