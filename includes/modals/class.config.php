...
class Config extends DatabaseObject
{
    ...
    protected static $db_fields = array('id', 'sitetitle', 'icon_upload', 'logo_upload', 'fb_upload', 'sitename', 'location_type', 'location_map', 'location_image', 'fiscal_address', 'mail_address', 'contact_info', 'email_address', 'breif', 'copyright', 'meta_title', 'site_keywords', 'site_description', 'google_anlytics', 'book_type', 'hotel_code', 'hotel_page', 'template', 'admin_template', 'headers', 'footer', 'search_box', 'search_result', 'action', 'fax','upcoming');
