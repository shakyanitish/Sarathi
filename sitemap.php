...
$staticblocks = array('home', 'contact-us', 'services-list', 'gallery-list');
...
$spackages = Subpackage:: get_relatedpkg();
...
//    $pakgLink = !empty($chkPar) ? '' . $spackage->slug . '' . $spackage->slug : '';
    $xml .= '
        <url>
            ...
            <lastmod>' . date('c', strtotime($spackage->added_date)) . '</lastmod>
