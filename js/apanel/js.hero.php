<script language="javascript">
    ...
    function getLocation() {
        return '<?php echo BASE_URL;?>includes/controllers/ajax.hero.php';
    }
...
$(document).ready(function () {
    ...
    var desiredPage = localStorage.getItem("herodbpage") ? parseInt(localStorage.getItem("herodbpage")) : 0;
    var desiredLength = localStorage.getItem("herodblength") ? parseInt(localStorage.getItem("herodblength")) : 10;
    ...
    var oTable = $('#example').dataTable({
        ...
        sURL: "<?php echo BASE_URL;?>includes/controllers/ajax.hero.php?action=sort",
    ...
    $(document).on("click", ".fg-button", function () {
        ...
        localStorage.setItem("herodbpage", currentPage);
    ...
    $(document).on('change', '#example_length select', function () {
        ...
        localStorage.setItem("herodblength", selectedLength);
    ...
    $(document).ready(function () {
        ...
        jQuery('#hero_frm').validationEngine({
            autoHidePrompt: true,
            scroll: false,
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (msg.action == 'success') {
                                ...
                                if (actionId == 2)
                                    setTimeout(function () {
                                        window.location.href = "<?php echo ADMIN_URL?>hero/list";
                                    }, 3000);
                                if (actionId == 1)
                                    setTimeout(function () {
                                        window.location.href = "<?php echo ADMIN_URL?>hero/addEdit";
                                    }, 3000);
                                if (actionId == 0)
                                    setTimeout(function () {
    ...
    function recordDelete(Re) {
        $('.MsgTitle').html('<?php echo sprintf($GLOBALS['basic']['deleteRecord_'], "hero")?>');
        $('.pText').html('Click on yes button to delete this hero permanently.!!');
...
function toggleMetadata(){
    ...
    function editRecord(Re) {
        window.location.href = "<?php echo ADMIN_URL?>hero/addEdit/" + Re;
    }
